...
const deck = [
    ...
    },
    {
        ...
        desc: 'Sorrow. Separation, quarrel, tears. Delay. Absence.', 
        rdesc: 'Confusion, loss, error.',
        cbd_desc: '',
        card: `
        .-------------------.
        |        III        |
    ...
    {
        name: 'Five of Swords',
        esc: 'Defeat. Failure. Loss. Powerlessness. Separation. Lies. Death.',
    ...
    {
        name: 'Ten of Swords',
        desc: 'Ruin. Total defeat. Death. The end of an illusion.', 
        rdesc: 'Transitory success. Improvement.',
        cbd_desc: '',
        card: `
        .-------------------.
        |         X         |
...
//var jsonObj = JSON.parse(deck);

var cards = JSON6.stringify(deck, null, 2);
